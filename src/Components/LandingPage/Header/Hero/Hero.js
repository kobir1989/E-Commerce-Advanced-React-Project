  ...
  return (
    <section className='lg:mt-20 mt-4 3xl:w-8/12 w-11/12 flex justify-between xl:flex-row items-center flex-col mx-auto'>
      ...
      <div className='xl:w-3/12 w-full flex flex-col text-white xl:ml-8'>
        <div className='hero_sub-1 lg:h-[14rem] h-[10rem] my-[3rem] xl:my-0 xl:mb-4 rounded flex items-center '>
          <div className='mx-4'>
        ...
        <div className='hero_sub-2 lg:h-[14rem] h-[10rem] rounded flex items-center'>
          <div className='mx-4'>
            <h2 className='uppercase'>
              new arrivals
              <br />
