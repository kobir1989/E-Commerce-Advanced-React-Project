...
const BlackFridayBanner = () => {
  return (
    <section
      className='relative lg:border-none border-dashed border-[1px] border-gray mt-20
     bg-black 3xl:w-8/12 lg:w-11/12 w-full flex lg:flex-row flex-col mx-auto items-center
     justify-between lg:h-[8rem] h-[20rem]'
    >
      <div className='curb_design  bg-[#B7C4CF] lg:h-full h-[8rem] lg:w-4/12 w-8/12 flex justify-center items-center'>
      ...
      <div className='bg-black lg:w-8/12 w-full h-full p-2 '>
        ...
        lg:border-dashed lg:border-[1px] lg:border-gray h-full'
        >
