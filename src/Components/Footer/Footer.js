...
const Footer = () => {
  return (
    <section className=' bg-[#03203C] text-lightGray lg:h-[30rem] py-12 lg:py-0 mt-20 flex justify-center'>
      <div className='3xl:w-8/12 lg:w-11/12 mx-auto w-full  flex flex-wrap items-center  justify-center'>
        <section className='lg:w-5/12 w-10/12 mb-8 lg:mb-0  flex flex-col justify-center'>
          ...
          <div className='flex'>
            <button className='w-[12rem] h-[4rem] hover:text-red bg-[#2D4263] rounded flex justify-evenly items-center'>
            ...
            <button className='w-[12rem] h-[4rem] hover:text-red bg-[#2D4263] flex justify-evenly items-center  mx-4'>
              <div className='text-[2rem]'>
                <Icons name={'Apple'} />
              </div>
              <div>
        ...
        <section className='flex lg:w-7/12 w-10/12 mb-8 lg:mb-0 flex-wrap  items-center justify-between '>
          <div>
            ...
            <ul className='text-[.8rem]'>
              <li className='mb-4 hover:text-red'>Career</li>
              <li className='mb-4 hover:text-red'>Our Store</li>
              <li className='mb-4 hover:text-red'>Our Cares</li>
              <li className='mb-4 hover:text-red'>Terms & Conditions</li>
            </ul>
          </div>
          <div>
            <h2 className='text-[1.2rem] font-bold mb-8'>Customar Care</h2>
            <ul className='text-[.8rem]'>
              <li className='mb-4 hover:text-red'>Help Center</li>
              <li className='mb-4 hover:text-red'>How to Buy</li>
              <li className='mb-4 hover:text-red'>Track Your Order</li>
              <li className='mb-4 hover:text-red'>Return and Refunds</li>
            </ul>
          </div>
          <div>
            ...
            <div className='flex my-4'>
              <span className='mr-4 hover:text-red'>
                <Icons name={'Mail'} />
              </span>
            ...
            <div className='flex justify-between w-[60%] mt-10'>
              <span className='bg-[#2E4C6D] p-4 rounded-full mr-2 hover:text-[#3944F7]'>
                <Icons name={'Fb'} />
              </span>
              <span className='bg-[#2E4C6D] p-4 rounded-full mx-2 hover:text-red'>
                <Icons name={'Insta'} />
              </span>
              <span className='bg-[#2E4C6D] p-4 rounded-full mx-2 hover:text-[#1B98F5]'>
                <Icons name={'Twee'} />
              </span>
              <span className='bg-[#2E4C6D] p-4 rounded-full mx-2 hover:text-red'>
                <Icons name={'Ytb'} />
